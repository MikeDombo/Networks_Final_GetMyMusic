...
void testBuildDiffStructDuplicateBoth() {
    ...
    json target = json(
            "{\"duplicateBothClientServer\":[{\"checksum\":\"6b9df6f\",\"clientFilenames\":[\"c.txt\"],\"serverFilenames\":[\"c.txt\"]}],\"uniqueOnlyClient\":[{\"checksum\":\"b9866403\",\"filename\":\"e.txt\"}],\"uniqueOnlyServer\":[{\"checksum\":\"e8b7be43\",\"filename\":\"a.txt\"}]}");
...
void testBuildPushPullComplicated() {
    ...
    json pullTarget = json(
            "{\"version\":1,\"type\":\"pullRequest\",\"request\":[{\"filename\":\"b.txt\",\"checksum\":\"12345\"},{\"filename\":\"a.txt\",\"checksum\":\"e8b7be43\"},{\"filename\":\"d5\",\"checksum\":\"333221\"},{\"filename\":\"d7\",\"checksum\":\"4321\"}]}");
    ...
    json pushTarget = json(
            "{\"version\":1,\"type\":\"pushRequest\",\"request\":[{\"checksum\":\"54321\",\"filename\":\"b (1).txt\",\"data\":\"\"},{\"checksum\":\"abcdef\",\"filename\":\"b.txt\",\"data\":\"\"},{\"filename\":\"d1\",\"checksum\":\"122333\",\"data\":\"\"},{\"filename\":\"d3\",\"checksum\":\"1234\",\"data\":\"\"},{\"checksum\":\"b9866403\",\"filename\":\"e.txt\",\"data\":\"\"}]}");
...
void testBuildPushPullOneFileServer() {
    ...
    json pullTarget = json(
            "{\"version\":1,\"type\":\"pullRequest\",\"request\":[{\"filename\":\"a.txt\",\"checksum\":\"e8b7be43\"}]}");
    json pullResult = buildPullRequestFromDiffStruct(src);
    cout << "    Target output (pull): " << pullTarget.stringify() << endl;
    cout << "    Actual output (pull): " << pullResult.stringify() << endl;
    assert(pullResult == pullTarget);
...
void testBuildPushPullOneFileClient() {
    ...
    json pushTarget = json(
            "{\"version\":1,\"type\":\"pushRequest\",\"request\":[{\"filename\":\"e.txt\",\"checksum\":\"b9866403\",\"data\":\"\"}]}");
    json pushResult = buildPushRequestFromDiffStruct(src);
    cout << "    Target output (push): " << pushTarget.stringify() << endl;
    cout << "    Actual output (push): " << pushResult.stringify() << endl;
    assert(pushResult == pushTarget);
...
void testBuildPushPullDuplicatesServer() {
    ...
    json src = json(
            "{\"duplicateOnlyServer\":[{\"checksum\":\"122333\",\"filenames\":[\"file10\",\"file11\"]},{\"checksum\":\"333221\",\"filenames\":[\"file12\",\"file13\"]}]}");
    json pullTarget = json(
            "{\"version\":1,\"type\":\"pullRequest\",\"request\":[{\"filename\":\"file10\",\"checksum\":\"122333\"},{\"filename\":\"file12\",\"checksum\":\"333221\"}]}");
    json pullResult = buildPullRequestFromDiffStruct(src);
    cout << "    Target output (pull): " << pullTarget.stringify() << endl;
    cout << "    Actual output (pull): " << pullResult.stringify() << endl;
    assert(pullResult == pullTarget);
...
void testBuildPushPullDuplicatesClient() {
    ...
    json pushTarget = json(
            "{\"version\":1,\"type\":\"pushRequest\",\"request\":[{\"filename\":\"file5\",\"checksum\":\"1234\",\"data\":\"\"}]}");
    json pushResult = buildPushRequestFromDiffStruct(src);
    cout << "    Target output (push): " << pushTarget.stringify() << endl;
    cout << "    Actual output (push): " << pushResult.stringify() << endl;
    assert(pushResult == pushTarget);
